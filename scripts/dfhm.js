...
(function() {
  var $, alertBox, clearWorldState, determineSize, getActiveField, getDimensions, getFieldRenderer, init, markFieldAsPopulated, onClearClick, onDimensionChange, onExportClick, onFileSelected, onImageLoaded, regenerateAll, setActiveField, upcase, worldState;
  ...
  regenerateAll = function() {
    var activeField, element, height, stateField, width, _ref;
    _ref = getDimensions(), width = _ref.width, height = _ref.height;
